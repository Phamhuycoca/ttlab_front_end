        ...
        <v-row>
            ...
            <v-col cols="7" class="text-right" lg="9" sm="8" md="8">
                <v-btn color="#0F60FF" prepend-icon="mdi-plus" class="text-capitalize" min-height="40" max-width="122"
                    rounded="lg" @click="(dialog = true), (currentValue = '')">Tạo mới</v-btn>
            </v-col>
        </v-row>
        <v-row>
            <v-col cols="12">
                <v-card style="border-radius: 16px; border: 1px">
                    <v-table density="compact">
                        ...
                        <tbody>
                            <tr v-if="users.length > 0" v-for="i in users" :key="i" style="height: 58px">
                                ...
                                <td class="text-truncate" style="max-width: 250px;">{{ i.email }}</td>
                    ...
                    i.birthday === undefined ||
                        ...
                        : formatDatetime(i.birthday)
                                ...
                                <td>
                                    {{
                        i.phone === undefined || i.phone === "" || i.phone === null
                            ? ""
                            : maskPhone(i.phone)
                    }}
                                </td>
                    ...
                    <v-row v-show="users.length > 0" class="ma-2">
                        ...
                        <v-col cols="4" sm="4" md="4" lg="4">
                            <p class="text-center page-table1" style="font-size: 15px; display: none; margin-top: 5px">
                                <span style="margin-bottom: 2px" @click="page = page - 1" :class="{
                    'text-grey-lighten-2': page === 1,
                    'text-black': page !== 1,
                }"><i class="fa-solid fa-angle-left" style="cursor: pointer"></i></span>
                                <span style="
                  ...
                  " class="ml-2 mr-2">{{ page }}</span>
                                <span style="margin-bottom: 2px" @click="page = page + 1" :class="{
                    'text-grey-lighten-2': page === lengthPage,
                    'text-black': page !== lengthPage,
                }"><i class="fa-solid fa-chevron-right" style="cursor: pointer"></i></span>
                            </p>
